...
const playGlobalSound = () => {
  ...
  try {
    ...
    const audio = new Audio("https://hebbkx1anhila5yf.public.blob.vercel-storage.com/files-blob/Milano-Cafe-main/public/ring-MzJyts28M9HaYjXaH9hu8A8FrFOZyX.mp3")
    audio.volume = 0.8
