...
import { Coffee, Home, LogOut, Mail, Package, ShoppingBag, Users, Settings, Layers, Camera, ChefHat } from "lucide-react"
...
const navigationItems = [
  ...
  { name: "Oshxona", href: "/admin/kitchen", icon: ChefHat },
  { name: "Kameralar", href: "/admin/cameras", icon: Camera },
